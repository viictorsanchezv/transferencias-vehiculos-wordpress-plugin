    <div class='row p-40 justify-content-between'>
        <div class='col-12 col-md-12 col-lg-12 mt-3 text-left' >
             <!-- documentos comprador -->
            <h3 class='mb-1 font-weight-bold principal-color title-border'>Cl&aacuteusulas del tr&aacutemite</h3>
        </div>
        ...
        <div class='col-12 col-md-12 col-lg-12 mt-3 text-left' id='clausulas'>
            ...
            <p class="font-weight-bold w-100" style="font-size: 15px; margin-top: 30px;">
        ...
        <div class='col-12 col-md-12 col-lg-12 mt-3 text-left'>
            <h3 class=' mt-5 font-weight-bold principal-color title-border'>Documentaci&oacuten del vendedor</h3>
        </div>
        
        <!-- documentos -->    
        <div class='col-12 col-md-6 col-lg-6 justify-content-center' style='display: none; ' id='impuesto-hacienda-container' >
            <div class='text-center column-bg-file p-2 card-fiel' >
                <p class='mt-2 mb-2 cursor-pointer' id='title-impuesto-hacienda' ><strong> Modelo 620 / 621 - Impuesto hacienda ITP </strong></p>
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-archivo-impuesto-hacienda' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
        ...
        <div class='col-12 col-md-6 col-lg-6 justify-content-center' style='display: none' id='contrato-compra-venta' >
            <div class='text-center column-bg-file p-2 card-fiel' >
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-archivo-ccompra' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
        ...
        <div class='col-12 col-md-6 col-lg-6 justify-content-center' style='display: flex' id='nif-vendedor-frontal'>
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-archivo-nifv-frontal' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
        ...
        <div class='col-12 col-lg-6 col-md-6 justify-content-center' style='display: flex' id='nif-vendedor-trasero'>
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-archivo-nifv-trasero' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
        ...
        <div class='col-12 col-lg-6 col-md-6 justify-content-center' style='display: none;' id='liquidacion-sucesiones-container'>
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-liquidacion-sucesiones' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
        ...
        <div class='col-12 col-lg-6 col-md-6 justify-content-center mt-2' style='display: none;' id='escritura-herencia-container'>
            <div class='text-center column-bg-file p-2 card-fiel' >
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-escritura-herencia' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
        ...
        <div class='col-12 col-lg-6 col-md-6 justify-content-center' style='display: none;' id='cif-empresa-vendedora'>
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-archivo-cif-empresa-vendedora' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
    ...
    <div class='row justify-content-center p-40 '>
        <div class='col-12 col-md-12 col-lg-12 mt-3 text-left'>
             <!-- documentos comprador -->
            <h3 class=' mt-5 font-weight-bold principal-color title-border'>Documentaci&oacuten del comprador</h3>
        </div>
    </div>
    
    <div class='row justify-content-between p-40'>
        <div class='col-12 col-md-6 col-lg-6 p-0' id='nif-vendedor-frontal'>
             <div class='text-center column-bg-file p-2 card-fiel' >
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-archivo-nifc-frontal' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
         ...
         <div class='col-12 col-lg-6 col-md-6 p-0' id='nif-vendedor-trasero'>
              <div class='text-center column-bg-file p-2 card-fiel' >
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-archivo-nifc-trasero' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
    ...
    <div class='row justify-content-center p-40'>
        <div class='col-12 col-md-12 col-lg-12 mt-3 text-left'>
            ...
            <h3 class=' mt-5 font-weight-bold principal-color title-border'>Documentaci&oacuten del veh&iacuteculo</h3>
        </div>
    </div>
    ...
    <div class='row justify-content-between p-40'>
        <div class='col-12 col-md-6 col-lg-6 p-0' id='ficha-tecnica-vehiculo-frontal'>
            <div class='text-center column-bg-file p-2 card-fiel' >
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-archivo-ftecnica-frontal' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
         ...
         <div class='col-12 col-md-6 col-lg-6 p-0' id='ficha-tecnica-vehiculo-trasero'>
             <div class='text-center column-bg-file p-2 card-fiel' >
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-archivo-ftecnica-trasera' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
        ...
        <div class='col-12 col-lg-12 col-md-12 mt-1 p-0' id='permiso-circulacion'>
            <div class='text-center column-bg-file p-2 card-fiel'  >
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-archivo-permiso-vehiculo' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
        ...
        <div class='col-12 col-lg-6 col-md-6 mt-1 p-0' id='factura-venta' style='display: none;'>
            <div class='text-center column-bg-file p-2 card-fiel'  >
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-factura-vehiculo' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
         ...
         <div class='col-12 col-lg-6 col-md-6 mt-1 p-0' id='informe-dgt-container' style='display: none;'>
            <div class='text-center column-bg-file p-2 card-fiel'  >
                ...
                <img width='64' height='64' class='mt-2 mb-2 cursor-pointer' id='imagen-informe-dgt' src="<?php echo plugin_dir_url( __DIR__ ).'assets/img/subir-archivo.png'; ?>" alt="Imagen archivo">
                <div class='file-input text-center'>
