    <div class='row p-3 m-0'>
        <div class='col-12 col-md-12 col-lg-12 text-left' style='font-size:17px;'>
            <h3 class='mb-1 font-weight-bold principal-color'>Informaci&oacuten personal del <strong class='principal-color' id='comprador-datos-personales'> comprador </strong> </h3>
    ...
    <div class='row p-3 m-0' id='container-direccion-comprador'>
        <div class='col-12 col-md-12 col-lg-12 text-left' style='font-size:17px;'>
            <h3 class='mb-1 font-weight-bold principal-color'>Direcci&oacuten del <strong class='principal-color' id='comprador-direccion-datos'> comprador </strong> </h3>
