    <div class='row p-3 m-0 p-40 justify-content-between'>
        <div class='col-12 col-md-12 col-lg-12 text-left'  style="margin-bottom: 1rem;"'>
            <h3 class='mb-1 font-weight-bold principal-color title-border'>Informaci&oacuten personal del <strong id='vendedor-datos-personales' > vendedor </strong> </h3>
            <p style="font-size: 15px;">Rellene a continuaci&oacuten los datos personales del vendedor del veh&iacuteculo.</p>
        </div>
        
        <!-- correo -->
        <div class='col-12 col-md-5 col-lg-5 m-0 text-left'>
        ...
        <div class='col-12 col-md-5 col-lg-5 text-left' id='dni-apoderado-container-vendedor' style='display: none;'>
            <div class="form-group">
    ...
    <div class='separator'></div>
     ...
     <div class='row p-3 m-0  p-40 justify-content-between' id='container-direccion-vendedor'>
        <div class='col-12 col-md-12 col-lg-12 text-left' style='margin-bottom: 1rem; "'>
            <h3 class='mb-1 font-weight-bold principal-color title-border' >Direcci&oacuten del <strong class='principal-color'  id='vendedor-direccion-datos'> vendedor </strong> </h3>
            <p style="font-size: 15px;">Rellene a continuaci&oacuten la direcci&oacuten del vendedor. 
